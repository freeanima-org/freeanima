...
| Capability Policy                                          | Hard tool constraints: skill `allowed_tools` + caller (cron/sleep) optional allow/deny; `deny` overrides `allow`; not a Mask preset wardrobe. Data allow/deny reserved. See [`skills.md`](../modules/skills.md), [`architecture.md`](../product/architecture.md) Capability Policy                             |
