...
function DialogOverlay({
  ...
  return (
    <ModalOverlayPrimitive
      ...
      className={cn(
        "fixed inset-0 isolate z-[70] bg-black/10 duration-100 data-entering:animate-in data-entering:fade-in-0 data-exiting:animate-out data-exiting:fade-out-0 supports-backdrop-filter:backdrop-blur-xs",
        className,
      )}
      {...props}
    >
...
function Dialog({
  ...
  onOpenChange,
  ...props
}: Omit<ModalOverlayPrimitiveProps, "className" | "children" | "isOpen" | "onOpenChange"> & {
  className?: string;
  children: React.ReactNode;
  ...
  return (
    <DialogOverlay
      ...
      {...(resolvedOpen !== undefined ? { isOpen: resolvedOpen } : {})}
