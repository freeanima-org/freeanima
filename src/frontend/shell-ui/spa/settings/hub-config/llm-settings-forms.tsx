...
function LlmCallParamsEditor({
  ...
  return (
    <div className="space-y-3 rounded-md border border-dashed p-3">
      ...
      {hubConfigNumberField("temperature", draft.temperature, (temperature) =>
        commit({ ...draft, temperature }),
      )}
      {hubConfigNumberField("topP", draft.topP, (topP) => commit({ ...draft, topP }))}
      {hubConfigNumberField("maxOutputTokens", draft.maxOutputTokens, (maxOutputTokens) =>
