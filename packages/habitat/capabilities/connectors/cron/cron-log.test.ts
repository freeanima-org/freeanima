...
} from "@freeanima/habitat/core/db/pg/cron/repos/cron-crud-repo.ts";
import { listCronLogs } from "@freeanima/habitat/core/db/pg/cron/repos/cron-log-repo.ts";
...
mock.module("@freeanima/habitat/core/db/pg/cron", () => ({
  createCronJob,
  upsertBuiltinCronJob,
  getCronJob,
  updateCronJob,
