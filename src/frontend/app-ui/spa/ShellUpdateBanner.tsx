...
import type { BuildChannel } from "@freeanima/frontend/portal-sdk/build-meta";
import { readGithubReleaseProxyPref } from "@freeanima/frontend/portal-sdk/github-release-proxy-prefs";
import { resolveAboutNativeBuildMeta } from "@freeanima/frontend/portal-sdk/native-build-meta.resolve";
import {
  dismissShellToast,
  showShellToast,
  SHELL_TOAST_IDS,
