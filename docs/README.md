...
| 主题         | 文件                             |
| ------------ | -------------------------------- |
| 数字生命定位 | [identity.md](identity.md)       |
| 自我层       | [self-layer.md](self-layer.md)   |
| 记忆体系     | [memory.md](memory.md)           |
| 压缩         | [compression.md](compression.md) |
| 睡眠机制     | [sleep.md](sleep.md)             |
| 安全         | [security.md](security.md)       |
| 数据库       | [database.md](database.md)       |
| 发版         | [versioning.md](versioning.md)   |
| 设计稿       | [designs/](designs/)             |
