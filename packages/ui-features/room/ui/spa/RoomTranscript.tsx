...
import { ChatMessageBubble } from "@freeanima/ui-features/chat/ui/spa/components/ChatMessageBubble.tsx";
      ...
      {messages.map((msg) => {
        ...
        return (
          <div key={msg.id} className="flex w-full flex-col gap-1">
            ...
            >
              <div
                className={`md-content${isMention ? " ring-primary/30 rounded-sm ring-1" : ""}`}
