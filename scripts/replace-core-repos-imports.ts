...
const SYMBOL_MODULE: Record<string, string> = {
  ...
  AutobiographicalMemoryCreateInput: "@freeanima/habitat/core/db/pg/autobiographical-memory/types",
  ...
  LimbicMemoryCreateInput: "@freeanima/habitat/core/db/pg/limbic-memory/types",
