...
import { WORKFLOW_SCENARIO_IDS } from "@freeanima/core/db/schema/entity/components/workflow.ts";
import type { JsonSchemaObject } from "@freeanima/core/tool/registry.ts";
import {
  digSchema,
  inferLiteralSchema,
