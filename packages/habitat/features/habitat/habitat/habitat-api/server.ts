...
import { createMcpBunHandler, isMcpPath } from "@freeanima/habitat/capabilities/mcp-server";
import { HABITAT_BASE_PATH } from "@freeanima/habitat/platform/ports/constants";
import type { HabitatTlsBunOptions } from "@freeanima/habitat/platform/tls/resolve-habitat-tls";
...
import { getRemoteToolsServerDeps } from "@freeanima/habitat/capabilities/outpost/transport/runtime-context";
...
export async function startApiHttpServers(
  ...
  const { coalesceBindHosts } = await import("@freeanima/habitat/platform/bind-hosts.ts");
