import type { GlobalOutboxSummary } from "@freeanima/frontend/portal-sdk/offline-module-cap";
import type { HabitatConnectionState } from "@freeanima/frontend/portal-sdk/habitat-connection";
