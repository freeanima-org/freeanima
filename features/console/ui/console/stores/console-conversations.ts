...
export const useConsoleConversationsStore = create<ConsoleConversationsState>((set, get) => ({
  conversations: [],
  ...
  async fetchConversations(opts) {
    ...
    try {
      ...
      logCaughtError("stores/console-conversations", e);
      set({
  ...
  async ensureConversationHeadline(id) {
    ...
    try {
      ...
      logCaughtError("stores/console-conversations/fetchHeadline", err);
      /* headline optional */
    }
  },
