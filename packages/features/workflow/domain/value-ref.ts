import type { JsonValue, ValueRef } from "@freeanima/core/db/schema/entity/components/workflow.ts";
import { jsonValueSchema } from "@freeanima/core/db/schema/entity/components/workflow.ts";
