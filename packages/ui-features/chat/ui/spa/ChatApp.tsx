...
import { SlashCommandResultPanel } from "@freeanima/ui-features/chat/ui/spa/components/SlashCommandResultPanel.tsx";
import { ConversationTranscript } from "@freeanima/ui-features/chat/ui/spa/components/ConversationTranscript.tsx";
import { ChatComposeForm } from "@freeanima/ui-features/chat/ui/spa/components/ChatComposeForm.tsx";
import type { ChatComposeSendPayload } from "@freeanima/ui-features/chat/ui/spa/components/ChatComposeForm.tsx";
import { ChatContextUsageButton } from "@freeanima/ui-features/chat/ui/spa/components/ChatContextUsage.tsx";
import { uploadChatAttachmentDrafts } from "@freeanima/ui-features/chat/ui/spa/lib/attachments.ts";
import type { TranscriptScrollApi } from "@freeanima/ui-features/chat/ui/spa/hooks/useStickToBottomScroll.ts";
import { openEntityResource } from "@freeanima/portal-sdk/open-entity-resource.ts";
import { ConversationListItem as ConversationListRow } from "@freeanima/ui-features/chat/ui/spa/components/ConversationListItem.tsx";
import { ConversationAnimaControl } from "@freeanima/ui-features/chat/ui/spa/components/ConversationAnimaControl.tsx";
import {
  listAgentSubjects,
  type AgentSubjectOption,
} from "@freeanima/ui-features/chat/ui/spa/lib/agent-subjects.ts";
import { useEdgeSwipeOpen } from "@freeanima/ui-features/chat/ui/spa/hooks/useEdgeSwipeOpen.ts";
import { useKeyboardInset } from "@freeanima/ui-features/chat/ui/spa/hooks/useKeyboardInset.ts";
import {
  composeKeyboardLift,
  measureAppBottomNavChromePx,
  shouldOwnCompactImmersiveForKeyboard,
} from "@freeanima/ui-features/chat/ui/spa/lib/keyboard-inset.ts";
import { formatConversationIdDateTime } from "@freeanima/ui-features/chat/ui/spa/lib/format-datetime.ts";
import {
  displayAwaitingReply,
  resolveStalledAfterLookup,
  shouldShowAwaitingPlaceholder,
} from "@freeanima/ui-features/chat/ui/spa/lib/display-recovery.ts";
import {
  readPersistedActiveStream,
  clearPersistedActiveStream,
} from "@freeanima/ui-features/chat/ui/spa/lib/active-stream-persist.ts";
import {
...
} from "@freeanima/ui-features/chat/ui/spa/lib/api.ts";
import { useChatUnreadStore } from "@freeanima/ui-features/chat/ui/spa/stores/chat-unread.ts";
import { useViewportConversationRead } from "@freeanima/ui-features/chat/ui/spa/hooks/use-viewport-conversation-read.ts";
import { runBootstrapConversation } from "@freeanima/ui-features/chat/ui/spa/lib/bootstrap-conversation.ts";
...
} from "@freeanima/ui-features/chat/ui/spa/lib/habitat-stream-client.ts";
import { LlmDebugPanel } from "@freeanima/ui-features/chat/ui/spa/components/LlmDebugPanel.tsx";
import type {
  ConversationListItem,
  LlmDebugSnapshots,
} from "@freeanima/ui-features/chat/ui/spa/lib/types.ts";
import {
  readModuleSelection,
  subscribeSubjectKind,
  writeModuleSelection,
} from "@freeanima/portal-sdk";
import { useSpeechPlayback } from "@freeanima/ui-features/chat/ui/spa/hooks/useSpeechPlayback.ts";
import { useStreamAutoSpeak } from "@freeanima/ui-features/chat/ui/spa/hooks/useStreamAutoSpeak.ts";
import { primeHabitatSpeechOutput } from "@freeanima/portal-sdk/speech/habitat-adapter";
import {
  loadAutoSpeakPref,
  saveAutoSpeakPref,
} from "@freeanima/ui-features/chat/ui/spa/lib/speech/auto-speak-pref.ts";
import { useChatStore } from "@freeanima/ui-features/chat/ui/spa/stores/chat.ts";
import { useConversationsStore } from "@freeanima/ui-features/chat/ui/spa/stores/conversations.ts";
import { useOutboxStore } from "@freeanima/ui-features/chat/ui/spa/stores/outbox.ts";
import {
  claimChatSend,
  createEphemeralChatSend,
  listChatOutboxEntries,
  releaseChatSend,
} from "@freeanima/ui-features/chat/ui/spa/lib/offline-send-store.ts";
import {
  buildChatStreamFlushContext,
  CHAT_OFFLINE_MODULE_ID,
  type ChatStreamFlushHandlers,
} from "@freeanima/ui-features/chat/ui/spa/lib/offline-stream-adapter.ts";
import type { DisplayItem, StreamApiEvent } from "@freeanima/ui-features/chat/ui/spa/lib/types.ts";
import { registerChatStreamContextFactory } from "@freeanima/portal-sdk/chat-stream-context.ts";
import { resolveOutboxScope } from "@freeanima/portal-sdk/offline-outbox";
import { flushOfflineModule } from "@freeanima/portal-sdk/offline-sync";
import { isRetriableOfflineWriteError } from "@freeanima/portal-sdk/prefer-online-write";
import {
  filterUndeliveredOutbox,
  isOutboxDeliveredOnDisplay,
  mergeOutboxStatusIntoDisplay,
  stripRedundantOptimisticDisplay,
} from "@freeanima/ui-features/chat/ui/spa/lib/outbox-display-sync.ts";
import type { SlashCommandItem } from "@freeanima/ui-features/chat/ui/spa/lib/slash-command-menu.ts";
