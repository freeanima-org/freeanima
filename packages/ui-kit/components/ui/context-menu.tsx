  ...
  return (
    <MenuItemPrimitive
      ...
      className={composeRenderProps(className, (resolvedClassName, renderProps) => {
        const selectionMode = (renderProps as { selectionMode?: "none" | "single" | "multiple" })
          .selectionMode;
        return cn(contextMenuItemVariants({ selectionMode }), resolvedClassName);
      })}
      {...omitUndefined({
    ...
    >
      {composeRenderProps(
        children,
        ariaRenderProps(
          (itemChildren, renderProps: { isSelected?: boolean; selectionMode?: string }) => (
            <>
              {renderProps.selectionMode !== "none" ? (
                ...
                >
                  {renderProps.isSelected ? <CheckIcon /> : null}
                </span>
              ) : null}
              {itemChildren}
            </>
