...
} from "@freeanima/host/core/db/pg/cron/repos/cron-crud-repo.ts";
import { listCronLogs } from "@freeanima/host/core/db/pg/cron/repos/cron-log-repo.ts";
...
mock.module("@freeanima/host/core/db/pg/cron", () => ({
  createCronJob,
  upsertBuiltinCronJob,
  getCronJob,
  updateCronJob,
