import type { GlobalOutboxSummary } from "@freeanima/frontend/shell-sdk/offline-module-cap";
import type { HabitatConnectionState } from "@freeanima/frontend/shell-sdk/habitat-connection";
