...
import * as serviceEntityVault from "./service.ts";

/** Minimal SAP server deps for vault handlers (structural superset: platform SapServerDeps). */
export type VaultSapServerDeps = {
  runtime: {
