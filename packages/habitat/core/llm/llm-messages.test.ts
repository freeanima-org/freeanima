...
import { messagesForApi } from "@freeanima/habitat/capabilities/llm-openai/messages.ts";
...
describe("mergeStreamingToolCalls", () => {
  it("merges deltas by index into one tool call with name", () => {
    let acc: Record<number, import("@freeanima/habitat/core/db/domain").ToolCall> = {};
