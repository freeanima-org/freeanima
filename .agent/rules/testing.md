...
| Tier                       | Packages                                                                                                                                                                   | Usage                                                                                                                          |
| -------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------ |
| Tier 1 in-memory adapters  | `@freeanima/kernel/logging/null`、`/memory`、`/testing`；`@freeanima/kernel/eventbus/memory`、`/null`、`/testing`；`@freeanima/kernel/hooks/testing`；`storage-repos/null` | `createNullSink`, `createTestLogger`, `createTestEventBus`, `createTestHookRegistry`, `MemoryEventQueue`, `nullPgRepositories` |
