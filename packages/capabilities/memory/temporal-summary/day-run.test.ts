...
const temporalSummaryOriginal = await import("@freeanima/core/db/pg/temporal-summary");
...
mock.module("@freeanima/core/db/pg/temporal-summary", () => ({
...
afterAll(() => {
  ...
  mock.module("@freeanima/core/db/pg/temporal-summary", () => temporalSummaryOriginal);
