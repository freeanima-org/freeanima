...
const subagentRowSchema = z.object({
  ...
  max_loop_iterations: z.number().nullable(),
  temperature_tier: z.enum(["focused", "balanced", "creative"]).nullable(),
...
const exampleRow = {
  ...
  temperature_tier: null as "focused" | "balanced" | "creative" | null,
