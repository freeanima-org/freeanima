...
import type { LimbicMemoryRow } from "@freeanima/features/console/protocol/console-contract/api";
import {
  Button,
  Card,
  CardContent,
...
import { listLimbicMemories } from "@freeanima/features/console/ui/console/lib/api.ts";
...
function LimbicMemoryPage() {
  ...
  return (
    <div>
      <h2 className="text-lg font-bold mb-1">{m.console_nav_limbic()}</h2>
      <p className="text-sm text-muted-foreground mb-4">{m.console_limbic_desc()}</p>
        ...
        <Card className="bg-muted py-0">
          <CardContent className="gap-3 py-4 px-4">
            <FormFieldset bordered={false} className="gap-3">
              <FormField label={m.console_limbic_search()} className="text-xs">
                <Input
                  value={query}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                <div>
                  ...
                  <Input
                    ...
                    placeholder={m.console_common_optional()}
                  />
                </div>
                <div>
              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead>{m.console_limbic_intensity()}</TableHead>
