...
export function habitatConfigNumberField(
  label: string,
  value: number | "",
...
export function habitatConfigBoolField(
  label: string,
  value: boolean,
...
export function readHabitatConfigRecord(
...
export function HabitatConfigRecordEntryEditor({
  ...
  const entries = useMemo(() => readHabitatConfigRecord(value), [value]);
