...
const vaultConnectorOriginal = await import("@freeanima/habitat/capabilities/connectors/vault");
...
afterAll(() => {
  ...
  mock.module("@freeanima/habitat/capabilities/connectors/vault", () => vaultConnectorOriginal);
});
