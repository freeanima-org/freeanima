...
import type { StructuredToolCall } from "@freeanima/engine/loop-mechanism/stream-reply";
import { ToolRoundBuffer, isClarifyTool } from "@freeanima/engine/loop-mechanism/stream-reply";
