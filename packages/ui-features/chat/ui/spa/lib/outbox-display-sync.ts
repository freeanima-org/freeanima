import type { DisplayItem } from "@freeanima/ui-features/chat/ui/spa/lib/types.ts";
import type { ChatOutboxEntry } from "@freeanima/ui-features/chat/ui/spa/lib/offline-send-store.ts";
