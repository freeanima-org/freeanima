...
const { buildHeadlessChatStreamFlushContext, chatStreamAdapter } =
  await import("@freeanima/ui-features/chat/ui/spa/lib/offline-stream-adapter.ts");
const { claimChatSend, resetChatSendClaimsForTests } =
  await import("@freeanima/ui-features/chat/ui/spa/lib/offline-send-store.ts");
import type { OfflineOutboxOp } from "@freeanima/portal-sdk/offline-outbox.ts";
