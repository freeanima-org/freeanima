...
const conversationOriginal = await import("@freeanima/core/db/pg/conversation");
const worldContextPgOriginal = await import("@freeanima/core/config/world-context-pg.ts");
...
mock.module("@freeanima/core/config/world-context-pg.ts", () => ({
...
afterAll(() => {
  ...
  mock.module("@freeanima/core/db/pg/conversation", () => conversationOriginal);
  mock.module("@freeanima/core/config/world-context-pg.ts", () => worldContextPgOriginal);
});
