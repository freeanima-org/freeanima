...
import { whenPortalHabitatRpcReady } from "@freeanima/portal-sdk/habitat-rpc-call";
import { reconnectHabitat } from "@freeanima/portal-sdk/habitat-connection.ts";
import { pomodoroRemainingMs } from "@freeanima/portal-sdk/pomodoro-remaining.ts";
import {
  getPomodoroSyncSnapshot,
  subscribePomodoroSync,
} from "@freeanima/portal-sdk/pomodoro-sync-local.ts";
import { readPomodoroActiveState } from "@freeanima/portal-sdk/pomodoro-active.ts";
import { pomodoroPhaseAccentKind } from "../../shared/phase-accent.ts";
import type { PomodoroActiveState } from "@freeanima/portal-sdk/pomodoro-active-types.ts";
import {
