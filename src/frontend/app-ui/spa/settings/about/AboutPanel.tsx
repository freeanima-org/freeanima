...
import { resolveHabitatApiOrigin } from "@freeanima/frontend/portal-sdk/habitat-api-origin";
...
import {
  ...
  type UpdateTrack,
} from "@freeanima/frontend/portal-sdk/app-update";
import { parseComponentBuildMeta } from "@freeanima/frontend/portal-sdk/build-meta";
import {
  GITHUB_RELEASE_PROXY_IDS,
  type GithubReleaseProxyId,
} from "@freeanima/frontend/portal-sdk/github-release-proxy";
import {
  readGithubReleaseProxyPref,
  writeGithubReleaseProxyPref,
} from "@freeanima/frontend/portal-sdk/github-release-proxy-prefs";
import {
  NATIVE_BUILD_META_CHANGED_EVENT,
  resolveAboutNativeBuildMeta,
} from "@freeanima/frontend/portal-sdk/native-build-meta.resolve";
import {
  getShellKind,
...
import { parseWebUiConfigJson } from "@freeanima/frontend/portal-sdk/web-ui-config";
