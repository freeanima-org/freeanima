...
import { isAlibabaRealtimeVoiceModel } from "@freeanima/core/llm/voice-generate-models";
import {
...
} from "@freeanima/core/tts/voice-params";
import {
  defaultVoiceIdForProtocol,
  formatVoiceIdsForToolHint,
} from "@freeanima/core/tts/voice-catalog";
import { synthesizeEdgeTts } from "@freeanima/core/tts/edge-synthesize";
import { generateOpenAiSpeech } from "@freeanima/capabilities/llm-openai/audio-speech";
import {
  assertAlibabaRealtimeModelReady,
  synthesizeAlibabaTts,
} from "@freeanima/capabilities/llm-openai/audio-alibaba";
