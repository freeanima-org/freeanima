 ...
 */
import { registerEmbeddedMigrations } from "@freeanima/habitat/core/db";
import { registerStandaloneRuntimeMeta } from "@freeanima/habitat/core/config/standalone-runtime-meta";
import { registerEmbeddedDocs } from "@freeanima/habitat/capabilities/tools/docs-embedded";
...
export async function bootStandalone(): Promise<void> {
  ...
  const { listEmbeddedMigrationsFromDir } =
    await import("@freeanima/habitat/core/db/migrations-dir-import");
  ...
  const { listEmbeddedDocsFromDir } =
    await import("@freeanima/habitat/capabilities/tools/docs-dir-import");
