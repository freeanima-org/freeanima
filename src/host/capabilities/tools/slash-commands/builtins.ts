...
import { onConversationCloseBeforeNew } from "@freeanima/host/platform/ports/conversation-close";
import { isConversationMeta } from "@freeanima/host/core/db/domain";
import { setHomeChannel } from "@freeanima/host/platform/ports/home-channel";
...
} from "@freeanima/host/capabilities/connectors/gateway/tool-display.ts";
import {
