...
import type { HookClarifyItem, HookStreamEvent, TurnControl } from "@freeanima/engine-hooks/loop";
import {
  beforeLlmCall,
  toolAfterCall,
  type BeforeLlmCallContext,
} from "@freeanima/engine-hooks/loop";
...
import { markToolLoopActivity, maybeApplyEmergencyCompression } from "@freeanima/engine-compress";
import {
  getToolRegistry,
  getToolSessionId,
  getToolRepos,
