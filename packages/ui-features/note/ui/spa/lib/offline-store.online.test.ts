...
import * as habitatFetchGate from "@freeanima/portal-sdk/habitat-fetch-gate";
import * as habitatTypedClient from "@freeanima/portal-sdk/habitat-typed-client.ts";
import {
  listOutboxOps,
  resolveOutboxScope,
  setOfflineOutboxBackendForTests,
} from "@freeanima/portal-sdk/offline-outbox";
import { setSatelliteOfflineCacheBackendForTests } from "@freeanima/portal-sdk/offline-cache";
import { resetOfflineModuleRegistryForTests } from "@freeanima/portal-sdk/offline-module-registry";
import { resetTempIdAllocatorForTests } from "@freeanima/portal-sdk/offline-temp-id";
import { resetTypedHabitatClientForTests } from "@freeanima/portal-sdk/habitat-typed-client.ts";
import { resetLocalPreferForTests } from "@freeanima/portal-sdk/local-prefer";
