...
function AutobiographicalMemoryPage() {
  ...
  return (
    <div>
      <h2 className="text-lg font-bold mb-1">{m.console_nav_autobio()}</h2>
      <p className="text-sm text-muted-foreground mb-4">{m.console_autobio_desc()}</p>
        ...
        <Card className="bg-muted py-0">
          <CardContent className="gap-3 py-4 px-4">
            <FormFieldset bordered={false} className="gap-3">
              <FormField label={m.console_autobio_search()} className="text-xs">
                <Input
                  value={query}
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                ...
                <div>
                  <FormFieldLabel className="text-xs py-0">
                    {m.console_autobio_source_conversation()}
                  </FormFieldLabel>
                  <Input
                    value={sourceSession}
