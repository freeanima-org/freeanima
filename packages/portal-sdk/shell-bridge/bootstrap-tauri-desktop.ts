...
import { loadTauriNativeBuildMetaFromAssets } from "@freeanima/portal-sdk/native-build-meta.read";
import { NATIVE_BUILD_META_CHANGED_EVENT } from "@freeanima/portal-sdk/native-build-meta.resolve";
import type {
  ShellNativeAlertPayload,
  ShellNativeAlertPermission,
} from "@freeanima/portal-sdk/shell-api.ts";
import { applyHabitatConfigToShell, notifyShellConfigChanged } from "./apply-habitat-to-shell.ts";
