...
- **浏览器形态入口：** `packages/portal/extension`（展示名 FreeAnima）— 直连栖息地 REST；Vault 主密码会话见 [`docs/modules/vault.md`](../modules/vault.md)；安装与 gecko id 见 [`docs/modules/portal.md`](../modules/portal.md)。
