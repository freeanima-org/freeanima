...
} from "@freeanima/core/config/resolved-world-context.ts";
import type { EntityRow } from "@freeanima/core/db/pg/entity";
...
const realWorldContext = await import("@freeanima/core/config/world-context-pg");
const worldContextOriginal = { ...realWorldContext };
const realEntity = await import("@freeanima/core/db/pg/entity");
...
mock.module("@freeanima/core/config/world-context-pg", () => ({
...
afterAll(() => {
  mock.module("@freeanima/core/db/pg", () => pgOriginal);
  mock.module("@freeanima/core/config/world-context", () => worldContextOriginal);
