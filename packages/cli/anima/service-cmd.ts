import { installErrorLogHandlers, logStartupError } from "@freeanima/server/logging";
import { existsSync, mkdirSync, readFileSync, writeFileSync } from "node:fs";
import { spawnSync, spawn } from "node:child_process";
import { isServerAlive, readStatusFile } from "@freeanima/server/alive.ts";
import {
  apiGet,
  checkServerAlive,
  animaBin,
...
import { validateBootstrapOnStartup } from "@freeanima/server/config";
