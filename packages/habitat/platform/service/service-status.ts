...
import { getTokenizerBindingSnapshot } from "@freeanima/habitat/engine";
import {
...
import { buildToolsStatus, resolveDefaultConversationToolSets } from "@freeanima/habitat/core/tool";
import {
  listCommandDefs,
  listCommandDefsForPlatform,
} from "@freeanima/habitat/capabilities/tools/slash-commands";
import { pingDatabase, isJiebaLoaded } from "@freeanima/habitat/core/db/pg";
import { countSemanticMemory } from "@freeanima/habitat/core/db/pg/semantic-memory";
import { countSearchableMessages } from "@freeanima/habitat/core/db/pg/conversation";
import { pingRedis } from "@freeanima/habitat/core/redis";
import { listLoadedTokenizerRepos, listTokenizerBindings } from "@freeanima/habitat/core/tokenizer";
import type {
  DependencyStatus,
  ExtensionSummaries,
  HealthSnapshot,
