import { createHook, type HookEffectOf } from "@freeanima/host/kernel/hooks";
...
export const toolAfterCall = createHook<ToolAfterCallContext, ToolAfterCallEffect>(
  "@freeanima/host/engine/loop-hooks/tool-after-call",
  "After tool call returns",
);

export const beforeLlmCall = createHook<BeforeLlmCallContext>(
  "@freeanima/host/engine/loop-hooks/before-llm-call",
