...
import { applyColorTheme, readColorTheme } from "@freeanima/portal-sdk/color-theme";
import { PortalQueryProvider } from "@freeanima/portal-sdk/portal-query";
import type { SettingsBinding } from "@freeanima/portal-sdk/settings";
...
class ShellErrorBoundary extends Component<ShellErrorBoundaryProps, ShellErrorBoundaryState> {
  ...
  override componentDidCatch(error: unknown, info: ErrorInfo): void {
    console.error("[app-ui]", error, info.componentStack);
  }
