...
Implementation target: `src/features/project/` (domain + habitat + `ui/spa` + `plugin.ts`); schemas under `src/core/db/schema/entity/components/`; SAP frames under `src/shared/rpc-contract/frames/`.
