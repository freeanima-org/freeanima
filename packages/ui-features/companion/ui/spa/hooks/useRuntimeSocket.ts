...
import { resolveCompanionDevOrigin } from "@freeanima/ui-features/companion/ui/spa/lib/companion-local.ts";
import { runtimeWsUrl } from "@freeanima/ui-features/companion/ui/spa/lib/api.ts";
