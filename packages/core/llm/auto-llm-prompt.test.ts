...
import { SELF_LAYER_SYSTEM_FRAME } from "@freeanima/capabilities/self";
import { MEMORY_REFERENCE_CITATION_RULE } from "@freeanima/capabilities/memory/memory-reference";
