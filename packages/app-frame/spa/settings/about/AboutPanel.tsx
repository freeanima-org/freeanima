...
import type { ComponentBuildMeta } from "@freeanima/portal-sdk/build-meta";
import { resolveHabitatApiOrigin } from "@freeanima/portal-sdk/habitat-api-origin";
...
import {
  ...
  type UpdateTrack,
} from "@freeanima/portal-sdk/app-update";
import { parseComponentBuildMeta } from "@freeanima/portal-sdk/build-meta";
import {
  GITHUB_RELEASE_PROXY_IDS,
  isGithubReleaseProxyId,
  type GithubReleaseProxyId,
} from "@freeanima/portal-sdk/github-release-proxy";
import {
  readGithubReleaseProxyPref,
  writeGithubReleaseProxyPref,
} from "@freeanima/portal-sdk/github-release-proxy-prefs";
import {
  applyHabitatServiceUpdate,
  checkHabitatServiceUpdate,
} from "@freeanima/portal-sdk/habitat-config-api";
import {
  NATIVE_BUILD_META_CHANGED_EVENT,
  resolveAboutNativeBuildMeta,
} from "@freeanima/portal-sdk/native-build-meta.resolve";
import { getShellKind, type ShellRuntimeKind } from "@freeanima/portal-sdk/shell-runtime.ts";
import { isTauriRuntime } from "@freeanima/portal-sdk/tauri-runtime";
import { parseWebUiConfigJson } from "@freeanima/portal-sdk/web-ui-config";
