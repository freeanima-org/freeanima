...
import type { DisplayItem, ConversationListItem } from "@freeanima/platform/connectors/webui/api";
...
type ChamberConversationsState = {
...
export const useChamberConversationsStore = create<ChamberConversationsState>((set, get) => ({
  conversations: [],
