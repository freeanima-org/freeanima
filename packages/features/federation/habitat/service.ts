...
} from "@freeanima/capabilities/federation/handshake.ts";
import {
...
import {
  ...
  FEDERATION_WS_PATH,
} from "@freeanima/capabilities/federation/config.ts";
import { getFederationManager } from "@freeanima/capabilities/federation/runtime-context.ts";
import { habitatCtx } from "@freeanima/features/habitat/habitat/habitat-api/handlers/runtime.ts";
import type { TrustedSatelliteRow } from "@freeanima/core/db/pg/federation";
