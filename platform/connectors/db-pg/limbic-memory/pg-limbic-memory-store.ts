...
import * as bySessionsRepo from "./repos/limbic-by-conversations-repo.ts";
...
export const pgLimbicMemoryStore: LimbicMemoryStorePort = {
  ...
  listByConversation: crudRepo.listLimbicMemoryBySession,
  listByConversations: bySessionsRepo.listLimbicMemoryBySessions,
