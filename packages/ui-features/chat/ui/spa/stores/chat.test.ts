...
const apiOriginal = await import("@freeanima/ui-features/chat/ui/spa/lib/api.ts");
const habitatRpcOriginal = await import("@freeanima/shared/habitat-rpc/bundled-browser.ts");

mock.module("@freeanima/ui-features/chat/ui/spa/lib/api.ts", () => ({
  ...apiOriginal,
...
afterAll(() => {
  mock.module("@freeanima/ui-features/chat/ui/spa/lib/api.ts", () => apiOriginal);
