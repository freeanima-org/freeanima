...
import { rememberFromArgs, semanticMemoryToolDefs } from "./semantic-memory-tools.ts";
...
export function registerMemoryTools(toolSets: ToolSetRegistry): void {
  toolSets.registerToolSet(
    "memory",
    "Core remember and semantic memory (search/create/update/merge); limbic/narrative via content_block_search",
    attachToolReturns(
      [
        {
