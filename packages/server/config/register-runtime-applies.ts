...
import { registerRuntimeConfigSchemas } from "@freeanima/core/config/schemas/runtime-config.ts";
import { resolveAndBindWorldContext } from "@freeanima/core/config/world-context-pg";
import { applyHostI18nConfig } from "@freeanima/core/i18n";
import { initLlmRuntime } from "@freeanima/core/llm";
import {
  discoverPlatforms,
  startPlatforms,
  stopPlatforms,
