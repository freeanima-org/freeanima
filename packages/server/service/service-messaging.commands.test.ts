...
import * as turn from "@freeanima/engine/turn";
...
import { registerBuiltins } from "@freeanima/capabilities/tools/slash-commands";
import * as goal from "@freeanima/engine/goal";
