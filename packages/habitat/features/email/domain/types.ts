import type { EmailAccountBody } from "@freeanima/habitat/core/db/schema/entity";
...
export type EmailAccountRow = import("@freeanima/shared/rpc-contract").EmailAccountRowPayload & {
  password: string;
  sync?: import("@freeanima/habitat/core/db/schema/entity").EmailAccountSync;
...
> & {
  ...
  body: string;
  content_type: import("@freeanima/habitat/core/db/schema/entity").EmailContentType;
  /** 纯文本（ToolSet 默认） */
  text: string;
  imap_mailbox: string;
