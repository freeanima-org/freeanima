...
const vaultConnectorOriginal = await import("@freeanima/capabilities/connectors/vault");

mock.module("@freeanima/capabilities/connectors/vault", () => ({
...
afterAll(() => {
  ...
  mock.module("@freeanima/capabilities/connectors/vault", () => vaultConnectorOriginal);
});
