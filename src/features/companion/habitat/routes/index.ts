...
export const companionHabitatRoutes = bindHabitatRouteHandlers(companionMethodDefs, {
  ...
  "companion.model.reorder": async (_deps, input) => service.serviceCompanionModelReorder(input),
  ...
  "companion.motion.reorder": async (_deps, input) => service.serviceCompanionMotionReorder(input),
