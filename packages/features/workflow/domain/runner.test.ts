...
import { minimalChatRuntime } from "@freeanima/core/config/test-helpers/minimal-llm-config.ts";
import type { WorkflowStep } from "@freeanima/core/db/schema/entity/components/workflow.ts";
...
const workflowRunOriginal = await import("@freeanima/core/db/pg/workflow-run");

mock.module("@freeanima/core/db/pg/workflow-run", () => ({
  ...workflowRunOriginal,
...
afterAll(() => {
  mock.module("@freeanima/core/db/pg/workflow-run", () => workflowRunOriginal);
});
