import { shouldUseNativeShellNavigation } from "@freeanima/portal-sdk/shell-runtime.ts";

/** 移动壳使用 hash 路由（#/chat），避免 WebView 对 /chat 等路径返回 404 */
export { shouldUseNativeShellNavigation as isNativeShellNavigation } from "@freeanima/portal-sdk/shell-runtime.ts";
