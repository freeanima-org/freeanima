import {
  ...
  writeOfflineCache,
} from "@freeanima/portal-sdk/offline-cache";
import { getIdMapping, resolveIdFields } from "@freeanima/portal-sdk/offline-id-map";
import {
  registerOfflineModule,
  registerOfflineModuleCap,
} from "@freeanima/portal-sdk/offline-module-registry";
import { getModulePendingCount } from "@freeanima/portal-sdk/offline-module-cap";
import type { RpcModuleAdapter } from "@freeanima/portal-sdk/offline-module-types";
import {
  enqueueOutboxOp,
  listOutboxOps,
  removeOutboxOp,
...
} from "@freeanima/portal-sdk/offline-list-merge";
import { flushOfflineModule, recordFlushIdMapping } from "@freeanima/portal-sdk/offline-sync";
import {
  allocateTempId,
  isTempId,
  prefersOfflineWritePath,
  seedTempIdAllocatorFromIdMap,
} from "@freeanima/portal-sdk/offline-temp-id";
import { preferOnlineWrite } from "@freeanima/portal-sdk/prefer-online-write";
import { getTypedHabitatClient } from "@freeanima/portal-sdk/habitat-typed-client.ts";
import { getUserSubjectId } from "@freeanima/portal-sdk/world-context.ts";
...
async function flushDiaryOp(
  op: OfflineOutboxOp,
  scope: string,
): Promise<import("@freeanima/portal-sdk/offline-module-types").FlushOpOutcome> {
  try {
