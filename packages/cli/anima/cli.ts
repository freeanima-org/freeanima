...
const { formatCliVersion } = await import("@freeanima/core/config/cli-install");
const { resolveServiceBuildMeta } = await import("@freeanima/server/service/service-build-meta");
