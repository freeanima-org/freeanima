import { advanceBubbleLocal } from "@freeanima/satellites/companion/spa/lib/runtime-local.ts";
import { useRemoteToolsHost } from "@freeanima/satellites/companion/spa/hooks/useRemoteToolsHost.ts";
