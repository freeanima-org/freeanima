...
export function TreeNode({
  ...
  if (node.type === "directory") {
    return (
      <div className="select-none">
        <button
          type="button"
          className="flex items-center gap-1 w-full px-1 py-0.5 rounded hover:bg-muted/40 text-left"
        ...
        {isExpanded ? (
          <div className="pl-3 border-l border/40 ml-2">
  ...
  return (
    <button
      type="button"
      className={[
        "flex items-center w-full px-1 py-0.5 pl-4 rounded hover:bg-muted/40 text-left truncate",
